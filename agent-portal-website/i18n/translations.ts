export const dict = {
  ...
  // Store Management
  businessManagement: { zh: "店铺管理", en: "Store Management" },
  businessList: { zh: "店铺列表", en: "Store List" },
  businessDetail: { zh: "店铺详情", en: "Store Detail" },
  businessId: { zh: "店铺ID", en: "Store ID" },
  businessName: { zh: "店铺名称", en: "Store Name" },
  ...
  businessNameDesc: { zh: "官方注册的商户名称", en: "Official registered business name" },
  ...
  menuFilesDesc: { zh: "店铺菜单文件（PDF、DOC、XLS）", en: "Menu files for the store (PDF, DOC, XLS)" },
